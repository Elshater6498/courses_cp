...
export const topicKeys = {
  ...
  byCourse: (courseId: string) =>
    [...topicKeys.all, "course", courseId] as const,
...
export const useTopicsByCourse = (
  courseId: string,
...
export const useTopicsByPriceRange = (
  ...
  return useQuery({
    ...
    queryFn: () =>
      topicService.getTopicsByPriceRange(minPrice, maxPrice, params),
  ...
  return useMutation({
    ...
    onSuccess: (response) => {
      ...
      if (
        ...
        typeof response.data.courseId === "object"
      ) {
  ...
  return useMutation({
    ...
    onSuccess: (response) => {
      ...
      if (response.data?._id) {
        queryClient.invalidateQueries({
          queryKey: topicKeys.detail(response.data._id),
        })
      }
