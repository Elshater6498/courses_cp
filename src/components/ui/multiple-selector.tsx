...
>(
  (
    ...
    const handleKeyDown = React.useCallback(
      (e: React.KeyboardEvent<HTMLDivElement>) => {
        ...
        if (input) {
          ...
          // If the user is typing, we should not open the dropdown
          if (e.key === "ArrowDown") {
            e.preventDefault();
            setOpen(true);
          }
    ...
    useEffect(() => {
      if (onSearchSync) {
        const doSearchSync = () => {
          const searchResult = onSearchSync(inputValue);
          setOptions(transToGroupOption(searchResult, groupBy));
        };
    ...
    }, [debouncedSearchTerm, onSearchSync, groupBy]);
